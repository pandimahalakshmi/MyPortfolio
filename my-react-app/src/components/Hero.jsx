function Hero() {
  return (
    <section id="home" className="mr-20 h-screen flex items-center justify-center bg-gray-900 text-white">
      ...
      <div className="text-center">
        ...
        <button className="mt-6 border-2 tracking-wider font-bold   border-yellow-400 hover:text-black hover:bg-yellow-400  text-white px-6 py-2 rounded-3xl">
          HIRE ME
        </button>
